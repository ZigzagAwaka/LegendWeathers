...
namespace LegendWeathers
{
    class Config
    {
        ...
        public readonly ConfigEntry<int> majoraMaskItemRarity;
        ...
        public Config(ConfigFile cfg)
        {
            ...
            majoraMaskItemRarity = cfg.Bind("Majora Moon", "Majora Mask Item natural rarity", 0, "The natural spawn rarity for the Majora's Mask special item. It's supposed to be spawned by the Majora Weather but you can also make it spawn naturally with this config. Set this value to -1 if you don't want the item to be registered at all.");
            cfg.Save();
