...
namespace LegendWeathers.Weathers
{
    public static class MajoraMoonPositions
    {
        ...
        private static readonly Dictionary<string, (Vector3, Vector3, Vector3)> positionInfo = new Dictionary<string, (Vector3, Vector3, Vector3)>
        {
            ...
            { "Offense", (new Vector3(117, 320, -170), new Vector3(45, 310, 0), new Vector3(117, 0, -150)) },
            { "Adamance", (new Vector3(-30, 350, -90), new Vector3(45, 320, 0), new Vector3(-22, 1, -78)) },
            ...
            { "Gordion", (new Vector3(100, 300, 100), new Vector3(45, 230, 0), new Vector3(-50, 0, 80)) },
            ...
            { "Triskelion", (new Vector3(-83, 300, 100), new Vector3(45, 170, 0), new Vector3(-83, 0, 49)) },
            ...
            { "Galetry", (new Vector3(125, 300, -77), new Vector3(45, 320, 0), new Vector3(127, 0, -77)) },
            { "Berunah", (new Vector3(-23, 301, -139), new Vector3(45, 30, 0), new Vector3(-23, 1, -139)) },
            { "Core", (new Vector3(-73, 400, 42), new Vector3(45, 130, 0), new Vector3(-73, -20, 42)) },
            { "Dreck", (new Vector3(15, 300, -144), new Vector3(45, 40, 0), new Vector3(15, 0, -144)) },
            { "Faith", (new Vector3(-130, 290, 69), new Vector3(45, 170, 0), new Vector3(-130, -9, 69)) },
            { "Repress", (new Vector3(-5, 298, 4), new Vector3(45, 90, 0), new Vector3(-29, 0, 8)) },
            { "Roart", (new Vector3(-76, 300, -83), new Vector3(45, 40, 0), new Vector3(-76, 0, -83)) },
